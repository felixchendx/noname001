...
func (tmpl *AdminTemplating) NewPageData() (*PageData_default) {
	return tmpl.baseBundle.Templating.NewPageData_default()
}

func (tmpl *AdminTemplating) RenderContent_default(name string, pageData *PageData_default, ctx *fasthttp.RequestCtx) (template.HTML, error) {
