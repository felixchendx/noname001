...
func (rcvr *StreamReceiver) SendRequest_ServiceInfo(reqStruct *ServiceInfoRequest) (*ServiceInfoReply, error) {
	var err error
...
func (pvdr *StreamProvider) recvRequest_ServiceInfo(reqJson string) (repJson string) {
