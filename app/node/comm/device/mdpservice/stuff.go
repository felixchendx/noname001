...
var (
	...
	COMMANDS = map[string]string{
		...
		CMD_DEVICE_SNAPSHOT_LIST: "DEVICE_SNAPSHOT_LIST",
		CMD_DEVICE_SNAPSHOT     : "DEVICE_SNAPSHOT",
	}
)

func DeviceProviderID(nodeID string) (providerID string) {
