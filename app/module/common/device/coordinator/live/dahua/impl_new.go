...
func (dev *DahuaDevice) PersistenceData() (baseTyping.BaseDevicePersistenceData) {
	return dev.cache.pDat
}

func (dev *DahuaDevice) DeviceSnapshot() (*baseTyping.BaseDeviceSnapshot) {
...
func (dev *DahuaDevice) TempErrorDetails() (map[string]string) {
