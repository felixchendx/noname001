...
func (dev *DahuaDevice) decideOnWhatToDo() {
...
func (dev *DahuaDevice) doInit() {
	go dev._init()
}
func (dev *DahuaDevice) doRetryInit() {
	go dev._init()
}

func (dev *DahuaDevice) doReload() {
	go dev._reload()
}
func (dev *DahuaDevice) doRetryReload() {
	go dev._reload()
}

func (dev *DahuaDevice) doKeepAlive() {
	go dev._keepAlive()
}

func (dev *DahuaDevice) doDeactivate() {
	go dev._deactivate()
}

func (dev *DahuaDevice) doDestroy() {
	go dev._destroy()
}

func (dev *DahuaDevice) _init() {
...
func (dev *DahuaDevice) _keepAlive() {
...
func (dev *DahuaDevice) _deactivate() {
