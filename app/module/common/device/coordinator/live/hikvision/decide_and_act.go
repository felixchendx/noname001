...
func (dev *HikvisionDevice) decideOnWhatToDo() {
...
func (dev *HikvisionDevice) doInit() {
	go dev._init()
}
func (dev *HikvisionDevice) doRetryInit() {
	go dev._init()
}

func (dev *HikvisionDevice) doReload() {
	go dev._reload()
}
func (dev *HikvisionDevice) doRetryReload() {
	go dev._reload()
}

func (dev *HikvisionDevice) doKeepAlive() {
	go dev._keepAlive()
}

func (dev *HikvisionDevice) doDeactivate() {
	go dev._deactivate()
}

func (dev *HikvisionDevice) doDestroy() {
	go dev._destroy()
}

func (dev *HikvisionDevice) _init() {
...
func (dev *HikvisionDevice) _reload() {
...
func (dev *HikvisionDevice) _keepAlive() {
...
func (dev *HikvisionDevice) _deactivate() {
