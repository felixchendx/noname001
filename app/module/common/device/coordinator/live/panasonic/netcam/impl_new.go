...
func (dev *PanasonicNetworkCamera) Init() {
...
func (dev *PanasonicNetworkCamera) Reload() {
	switch dev.cache.lDat.State {
...
func (dev *PanasonicNetworkCamera) Destroy() {
	switch dev.cache.lDat.State {
	case baseTyping.DEVICE_LIVE_STATE__DESTROY:
...
func (dev *PanasonicNetworkCamera) PersistenceData() (baseTyping.BaseDevicePersistenceData) {
	return dev.cache.pDat
}

func (dev *PanasonicNetworkCamera) DeviceSnapshot() (*baseTyping.BaseDeviceSnapshot) {
...
func (dev *PanasonicNetworkCamera) TempErrorDetails() (map[string]string) {
