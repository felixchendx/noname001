...
import (
	...
	"noname001/app/module/feature/stream/filesystem"
	...
	"noname001/app/module/feature/stream/coordinator"
	"noname001/app/module/feature/stream/service"
	"noname001/app/module/feature/stream/runner"

	"noname001/app/module/feature/stream/intface"
)
...
func NewModule(params *ModuleParams) (*Module, error) {
	...
	mod.logPrefix = "app.feature.stream"
	...
	intface.AssignStreamEventProvider(mod.evHub)
	mod.commBundle.StreamProvider.AssignDataHandler(mod.service)
...
func (mod *Module) Init() (err error) {
	// TODO: also embed sample.mp4 for local stream testing
