...
import (
	...
	"noname001/corebiz/integration/hikvision/httpapi/v1"
	"noname001/corebiz/integration/hikvision/httpapi/dirty"
)
...
func NewAPIClient(params *APIClientParams) (*APIClient, error) {
	...
	api.APIDirty, err = dirty.NewAPIClient(&dirty.APIClientParams{
		api.context,
		api.logger,
		api.protocol, api.hostname, api.port, api.username, api.password,
		DEFAULT_API_TIMEOUT,
